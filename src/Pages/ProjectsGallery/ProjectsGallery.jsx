                ...
                <a href="https://hostel-management-9654d.web.app/" target="blank">
                    <div className="card lg:w-[450px] bg-[#0590fa] shadow-2xl">
                        <div className="p-4">
                            ...
                            <h2 className="card-title my-2">Hostel Management</h2>
                ...
                <a href="https://job-finder-hub.web.app/" target="blank">
                    <div className="card lg:w-[450px] bg-[#0590fa] shadow-2xl">
                        <div className="p-4">
                            ...
                            <h2 className="card-title my-2">Job Finder Hub</h2>
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Molestias officiis culpa nemo alias omnis nulla.</p>
                        </div>
                    </div>
                </a>
                <a href="https://techno-and-electro-client.web.app/" target="blank">
                    <div className="card lg:w-[450px] bg-[#0590fa] shadow-2xl">
                        <div className="p-4">
                            ...
                            <h2 className="card-title my-2">Technology & Electronics e-commerce site </h2>
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Molestias officiis culpa nemo alias omnis nulla.</p>
                        </div>
                    </div>
                </a>
                <a href="https://corporate-event-manageme-92f84.web.app/" target="blank">
                    <div className="card lg:w-[450px] bg-[#0590fa] shadow-2xl">
                        <div className="p-4">
                            ...
                            <h2 className="card-title my-2">Corporate Event Management</h2>
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Molestias officiis culpa nemo alias omnis nulla.</p>
                        </div>
                    </div>
                </a>
                <a href="https://roasted-honey.surge.sh/" target="blank">
                    <div className="card lg:w-[450px] bg-[#0590fa] shadow-2xl">
                        <div className="p-4">
                            ...
                            <h2 className="card-title my-2">Donation Campaign</h2>
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Molestias officiis culpa nemo alias omnis nulla.</p>
                        </div>
                    </div>
                </a>
                <a href="https://sayedul3731.github.io/my-first-assignment-website/" target="blank">
                    <div className="card lg:w-[450px] bg-[#0590fa] shadow-2xl">
                        <div className="p-4">
                            ...
                            <h2 className="card-title my-2">Flower Shop</h2>
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Molestias officiis culpa nemo alias omnis nulla.</p>
                        </div>
                    </div>
                </a>
