    ...
    return (
        <div className="flex flex-col-reverse md:flex-row justify-between items-center w-full mb-32 md:mb-0 md:h-[600px] ">
            <div className="w-1/2  flex flex-col justify-start">
                <h1 className="text-3xl md:text-5xl mt-10 font-bold  text-white "><span className="text-[#ff03f7]">Hi,</span> This is <br />MD SAYEDUL HAQUE
                </h1>
                <p className="text-xl md:text-2xl font-semibold my-5 flex text-[#ff03ee]">I'm Front-End Web Developer
                </p>
                <p>
