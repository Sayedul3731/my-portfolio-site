...
const Banner = () => {
    return (
        <div className="flex flex-col-reverse lg:flex-row justify-between items-center w-full mb-20 md:mb-20 md:mb-0 md:h-[650px] lg:h-[600px] ">
            ...
            <div className="w-5/6 md:w-5/6 lg:w-1/2 flex md:justify-center justify-end mb-10 md:mb-0">
